	...
	describe('PerspectiveCamera', () => {
		...
		test('updateProjectionMatrix', () => {
			...
			reference.set(
				...
				// 0.7330642722231783, 0, 0, 0,
				// 0, -1.3032253728412058, 0, 0,
				// 0, 0, -1.0006668889629878, -1,
				// 0, 0, -0.20006668889629879, 0
			...
			assert(
				matrixEquals4(reference, m, 0.000001),
				'expected matrices to be approximately equal. ' + m.elements.toString()
			)
		})
